          ...
          <Popover placement="bottom-start" matchWidth>
            <PopoverTrigger>
              <Box
                ...
                spacing="4px"
              >
                <Text width="148px">{repeatType && repeatType.length > 0 ? repeatType : "Every week"}</Text>
                <ArrowDropdown />
              </Box>
            </PopoverTrigger>
            <PopoverContent width="200px" height="auto" _focus={{outline:"none", boxShadow:"none"}} background="white">
