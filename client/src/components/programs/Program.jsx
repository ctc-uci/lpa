...
export const Program = () => {
  ...
  return (
    // Having a parent flex component makes it easier to handle page styling since you can edit this parent component
    // instead of having to edit the Navbar as the parent (Dangerous since the Navbar is the parent in almost every
    // other page and you may want different formatting per page) or playing around with padding for the page content
    // like we had to do here by adding padding to the Box component
    <Box display="flex">
      <Navbar />
