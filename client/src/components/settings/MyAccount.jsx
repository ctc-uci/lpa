...
export const MyAccount = () => {
  ...
  const [isInvalidTemporaryFirstName, setIsInvalidTemporaryFirstName] =
    useState(false);
  const [isInvalidTemporaryLastName, setIsInvalidTemporaryLastName] =
    useState(false);
        ...
        >
          ...
          >
            ...
            >
              <Grid
                templateColumns={
                  isEditing ? "10rem 1fr auto 1fr" : "10rem 7.5rem 7.5rem"
                }
                alignItems="center"
                width="100%"
                  ...
                  <InputGroup flex={1}>
                    ...
                    >
                      ...
                      <ModalContent>
                        ...
                        <ModalBody>
                          <Text>
                            Please open your inbox for an email from La Peña
                            Cultural Center. Click on the link there to reset
                            password.
                          </Text>
                        </ModalBody>
                        <ModalFooter>
